...
const Header = () => {
    ...
    return (
        <header className='absolute inset-x-0 top-0 bg-slate-700'>
            <NavLink className="flex h-screen" to='/'>
                <img src={logo} className="nav-logo-link inline absolute left-5 top-2 w-20 h-20 border-2 rounded-full" alt="Bitter Logo"/>
            </NavLink>
