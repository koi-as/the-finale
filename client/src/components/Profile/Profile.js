        ...
        <div className='container bg-slate-800 flex justify-center absolute ml-64 inset-y-20 border-2 w-8/12'>
            <div className='feed-cont flex inline-flex flex-col'>
                <div className="profile-title">
                    <h1 className="profile-header text-center">Profile</h1>
                </div>
                <div className="about-containter text-center">
                    <h2 className="title mb-2">About Me</h2>
                    <textarea className="about" placeholder="About Me"></textarea>
                </div>
                <div className="gender-container text-center">
                    <h2 className="title mb-0">Gender</h2>
                    <div>
